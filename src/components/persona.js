  ...
  const profileCardData = [
    ...
    },
    {
      ...
      bullets: [
        ...
        {
          id: 3,
          description: "Core belief: If it can be imagined, it can be created.",
        },
      ],
    },
  ];
    ...
    <section className="max-w-5xl mx-auto px-8 sm:px-[70px] md:px-28 relative py-10 sm:py-16">
      <div className="grid md:grid-cols-2 md:items-center">
        <div>
          <div className="z-10 relative">
            <SecondaryText title="Persona" />
            <p className="text-smoke elza text-sm md:text-base mb-4">
              We are a small, scrappy group of marketers passionate about
              creating killer work. We are located right on the water and
              influenced by the sailors and fishermen on the docks and in our
              building. We were founded with the intention to bring passion to
              our work and not just follow in the footsteps of other agencies.
              We never settle for the obvious solution and are always looking
              for ways to do unexpected things for our clients. We are who we
              are, and we don&rsquo;t want to fit into the box of a “creative
              agency.”
            </p>
            <p className="text-smoke text-sm md:text-base elza">
              VSSL is two archetypes: The Outlaw and The Creator. That
              influences everything in our brand: our positioning, brand voice,
              visual identity, and culture. It gives us a very different brand
              voice that reflects our disruptive spirit, allows us to operate
              differently than other agencies, and gives us the opportunity to
              be super creative with our design. We are not just another agency,
      ...
      <div className="grid md:grid-cols-5 mt-10 md:mt-20">
        <Image
          ...
          className="absolute left-0 hidden md:block transition-all duration-300"
        />
